          ...
          <div className='flex justify-between '>
            <div className=''>
              <div className='flex items-center justify-center'>
                <label
                  for='dropzone-file'
                  className='flex flex-col items-center justify-center w-32 h-40 border-2 bg-white border-gray-300 border-dashed rounded-lg cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600'>
